...
import { AlmacenArchivos } from '../../application/ports/AlmacenArchivos.js';

const API = 'https://api.cloudinary.com/v1_1';
const FORMATOS = 'jpg,jpeg,png,webp,heic';
 ...
 */
export class CloudinaryAlmacen extends AlmacenArchivos {
